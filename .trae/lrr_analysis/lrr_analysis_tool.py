...
def main():
    ...
    parser.add_argument(
        "--extract-rules", action="store_true", help="Extract rule categories from LRR"
    )
    parser.add_argument(
        "--create-templates",
        action="store_true",
        help="Create template files for rule categories",
    )
    parser.add_argument(
        "--search-tests",
        type=str,
        help="Search for tests related to a specific rule number",
    )
