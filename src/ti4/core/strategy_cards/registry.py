...
class StrategyCardRegistry:
    ...
    def register_strategy_card(
        self, card_type: StrategyCardType, card: BaseStrategyCard
    ) -> None:
        """Register a strategy card in the registry.

        Args:
            card_type: The strategy card type
            card: The strategy card implementation

        Requirements: 5.7 - Registry system for card registration
        """
        self._cards[card_type] = card
