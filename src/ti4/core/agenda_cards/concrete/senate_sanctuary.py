"""Senate Sanctuary directive card implementation."""
...
class SenateSanctuary(DirectiveCard):
    """Senate Sanctuary directive card.

    LRR Reference: Rule 7 - Agenda Cards
    """

    def __init__(self) -> None:
        """Initialize Senate Sanctuary directive card."""
        super().__init__("Senate Sanctuary")
