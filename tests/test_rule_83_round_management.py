...
class TestRoundManagement:
    ...
    def test_reset_round_returns_all_cards_to_common_play_area(self):
        ...
        assert coordinator.get_player_strategy_card("player3") == StrategyCardType.POLITICS
        assert len(coordinator.get_available_cards()) == 5  # 8 total - 3 assigned = 5 available
    ...
    def test_reset_round_readies_all_cards_for_selection(self):
        ...
        assert coordinator.is_strategy_card_exhausted("player2", StrategyCardType.DIPLOMACY)
    ...
    def test_reset_round_restores_initial_card_state(self):
        ...
        assert coordinator.is_strategy_card_exhausted("player1", StrategyCardType.LEADERSHIP)
        participants = coordinator.get_secondary_ability_participants(StrategyCardType.LEADERSHIP)
        ...
        participants_after_reset = coordinator.get_secondary_ability_participants(StrategyCardType.LEADERSHIP)
    ...
    def test_reset_round_maintains_proper_card_lifecycle_management(self):
        ...
        selection_result = coordinator.select_strategy_card("player1", StrategyCardType.TECHNOLOGY)
        assert selection_result.success
        assert coordinator.get_player_strategy_card("player1") == StrategyCardType.TECHNOLOGY