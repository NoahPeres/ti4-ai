...
class ObjectiveTestHelpers:
    ...
    @staticmethod
    def create_public_objective(obj_id: str, name: str, phase: GamePhase, points: int = 1) -> Objective:
    ...
    @staticmethod
    def create_secret_objective(obj_id: str, name: str, phase: GamePhase, points: int = 1) -> Objective:
    ...
    @staticmethod
    def create_game_state_with_secret_objectives(player_id: str, secret_objectives: list[Objective]) -> GameState:
...
def player_with_secrets(game_state, standard_objectives):
    ...
    return ObjectiveTestHelpers.create_game_state_with_secret_objectives("player1", secret_objs)


def assert_objective_scored(game_state: GameState, player_id: str, objective: Objective, expected_points: int = None):
...
def assert_scoring_fails(game_state: GameState, player_id: str, objective: Objective, phase: GamePhase, error_pattern: str):
