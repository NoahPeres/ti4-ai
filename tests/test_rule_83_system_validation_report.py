...
class TestRule83KnownIssuesReport:
    ...
    def test_known_issues_report(self) -> None:
        ...
        print(
            "   Status: ⚠️  Requires user confirmation per manual_confirmation_protocol.md"
        )
        print(
            "   Issue: Specific warfare abilities (token removal, redistribution) need confirmation"
        )
        ...
        print(
            "   Issue: Tests expected 'generate_legal_actions' but implementation had 'generate_legal_decisions'"
        )
