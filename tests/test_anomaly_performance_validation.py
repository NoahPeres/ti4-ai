...
from src.ti4.core.movement_rules import MovementRuleEngine, MovementContext
    ...
    def test_concurrent_access_performance(self):
        ...
        def worker():
            ...
            for _ in range(100):
                ...
                modifiers = self.anomaly_manager.get_combat_modifiers(shared_system, True)
            end_time = time.time()
...
class TestAnomalySystemScalability:
    ...
    def test_multiple_anomaly_types_per_system_scalability(self):
        ...
        for system in systems:
            effects = self.anomaly_manager.get_anomaly_effects_summary(system)
            modifiers = self.anomaly_manager.get_combat_modifiers(system, True)
            blocking = self.anomaly_manager.is_system_blocking_movement(system, False)
