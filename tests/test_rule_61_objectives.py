...
class TestPhaseSpecificObjectiveScoring:
    ...
    def test_can_only_score_objective_in_correct_phase(self):
        ...
        state1 = game_state.score_objective("player1", status_objective, GamePhase.STATUS)
        ...
        assert_scoring_fails(
            game_state, "player1", status_objective, GamePhase.ACTION,
        ...
        assert_scoring_fails(
            game_state, "player1", status_objective, GamePhase.AGENDA,
    ...
    def test_status_phase_scoring_limits(self):
        ...
        public_obj1 = ObjectiveTestHelpers.create_public_objective("pub1", "Public 1", GamePhase.STATUS)
        public_obj2 = ObjectiveTestHelpers.create_public_objective("pub2", "Public 2", GamePhase.STATUS)
        secret_obj1 = ObjectiveTestHelpers.create_secret_objective("sec1", "Secret 1", GamePhase.STATUS)
        secret_obj2 = ObjectiveTestHelpers.create_secret_objective("sec2", "Secret 2", GamePhase.STATUS)
        
        # Assign secret objectives to player first
        state_with_secrets = ObjectiveTestHelpers.create_game_state_with_secret_objectives(
            "player1", [secret_obj1, secret_obj2]
        )
        
        # Should be able to score one public objective
        state1 = state_with_secrets.score_objective("player1", public_obj1, GamePhase.STATUS)
        ...
        assert_scoring_fails(
            state2, "player1", public_obj2, GamePhase.STATUS,
        ...
        assert_scoring_fails(
            state2, "player1", secret_obj2, GamePhase.STATUS,
    ...
    def test_action_phase_unlimited_scoring(self):
        ...
        action_obj1 = ObjectiveTestHelpers.create_public_objective("act1", "Action 1", GamePhase.ACTION)
        action_obj2 = ObjectiveTestHelpers.create_public_objective("act2", "Action 2", GamePhase.ACTION)
        action_obj3 = ObjectiveTestHelpers.create_secret_objective("act3", "Action 3", GamePhase.ACTION)
        
        # Assign secret objective to player first
        state_with_secret = ObjectiveTestHelpers.create_game_state_with_secret_objectives("player1", [action_obj3])
        
        # Should be able to score multiple objectives in action phase
        state1 = state_with_secret.score_objective("player1", action_obj1, GamePhase.ACTION)
    ...
    def test_agenda_phase_unlimited_scoring(self):
        ...
        agenda_obj1 = Objective("ag1", "Agenda 1", "First agenda", 1, False, GamePhase.AGENDA)
        agenda_obj2 = Objective("ag2", "Agenda 2", "Second agenda", 1, False, GamePhase.AGENDA)
        
        # Assign secret objectives to player first
        state_with_secrets = game_state.assign_secret_objective("player1", agenda_obj1)
        state_with_secrets = state_with_secrets.assign_secret_objective("player1", agenda_obj2)
        
        # Should be able to score multiple objectives in agenda phase
        state1 = state_with_secrets.score_objective("player1", agenda_obj1, GamePhase.AGENDA)
    ...
    def test_combat_objective_scoring_limit(self):
        ...
        combat_obj1 = Objective("cb1", "Combat 1", "First combat", 1, True, GamePhase.ACTION)
        combat_obj2 = Objective("cb2", "Combat 2", "Second combat", 1, True, GamePhase.ACTION)
        
        # Should be able to score one objective during combat
        state1 = game_state.score_objective_during_combat("player1", combat_obj1, "combat_1")
        ...
        state2 = state1.score_objective_during_combat("player1", combat_obj2, "combat_2")
    ...
    def test_objective_can_only_be_scored_once_per_game(self):
        ...
        objective = Objective("test", "Test", "Test objective", 1, True, GamePhase.ACTION)
...
class TestObjectiveScoringMechanics:
    ...
    def test_score_objective_awards_victory_points(self):
        ...
        objective = Objective("test", "Test", "Test objective", 2, True, GamePhase.ACTION)
        ...
        result_state = game_state.score_objective("player1", objective, GamePhase.ACTION)
    ...
    def test_multiple_players_can_score_same_public_objective(self):
        ...
        public_objective = Objective("pub", "Public", "Public objective", 1, True, GamePhase.ACTION)
        
        # Both players should be able to score the same public objective
        state1 = game_state.score_objective("player1", public_objective, GamePhase.ACTION)
    ...
    def test_secret_objectives_are_player_specific(self):
        ...
        secret_objective = Objective("sec", "Secret", "Secret objective", 1, False, GamePhase.ACTION)
        
        # Assign secret objective to player1
        state_with_secret = game_state.assign_secret_objective("player1", secret_objective)
        
        # Player1 should be able to score their own secret objective
        new_state = state_with_secret.score_objective("player1", secret_objective, GamePhase.ACTION)
...
class TestObjectivePhaseIntegration:
    ...
    def test_status_phase_objective_scoring_step(self):
        ...
        objective = Objective("test", "Test", "Test objective", 1, True, GamePhase.STATUS)
        result_state = game_state.execute_status_phase_step_1_score_objectives("player1", [objective])
    ...
    def test_phase_transition_resets_scoring_limits(self):
        ...
        public_obj1 = Objective("pub1", "Public 1", "First public", 1, True, GamePhase.STATUS)
        public_obj2 = Objective("pub2", "Public 2", "Second public", 1, True, GamePhase.STATUS)
