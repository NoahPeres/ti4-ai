...
class TestRule101Wormholes:
    ...
    def _create_galaxy_with_wormhole_systems(self, wormhole_configs: list[tuple[str, str, HexCoordinate]]) -> Galaxy:
        """
    ...
    def _create_system_with_wormholes(self, system_id: str, wormhole_types: list[str]) -> System:
        """
    ...
    def test_same_wormhole_type_adjacency(self, wormhole_type: str):
        ...
        assert galaxy.are_systems_adjacent(f"{wormhole_type}_system_1", f"{wormhole_type}_system_2"), \
    ...
    def test_different_wormhole_types_are_not_adjacent(self):
        ...
        coords = [HexCoordinate(0, 0), HexCoordinate(3, 0), HexCoordinate(0, 3), HexCoordinate(3, 3)]
        wormhole_configs = [
    ...
    def test_multiple_wormhole_types_create_multiple_adjacencies(self):
        ...
        multi_system = self._create_system_with_wormholes("multi_wormhole_system", ["alpha", "beta"])
        ...
        assert galaxy.are_systems_adjacent("multi_wormhole_system", "alpha_only_system"), \
            "Multi-wormhole system should be adjacent to alpha system"
        assert galaxy.are_systems_adjacent("multi_wormhole_system", "beta_only_system"), \
        ...
        assert not galaxy.are_systems_adjacent("multi_wormhole_system", "gamma_only_system"), \
    ...
    def test_system_with_no_wormhole_not_adjacent_to_wormhole_systems(self):
        ...
        assert not galaxy.are_systems_adjacent("no_wormhole_system", "alpha_wormhole_system"), \
