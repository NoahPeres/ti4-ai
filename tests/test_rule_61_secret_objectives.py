...
class TestSecretObjectiveOwnership:
    ...
    def test_players_can_only_score_owned_secret_objectives(self):
        ...
        secret_obj = Objective("sec1", "Secret 1", "Player 1's secret", 1, False, GamePhase.STATUS)
        ...
        state1 = state_with_secret.score_objective("player1", secret_obj, GamePhase.STATUS)
        ...
        with pytest.raises(ValueError, match="Cannot score secret objective.*not owned by player"):
    ...
    def test_secret_objectives_are_hidden_from_other_players(self):
        ...
        secret_obj1 = Objective("sec1", "Secret 1", "Player 1's secret", 1, False, GamePhase.STATUS)
        secret_obj2 = Objective("sec2", "Secret 2", "Player 2's secret", 1, False, GamePhase.STATUS)
    ...
    def test_players_can_have_maximum_three_secret_objectives(self):
        ...
        secret_objectives = [
            Objective(f"sec{i}", f"Secret {i}", f"Secret objective {i}", 1, False, GamePhase.STATUS)
        ...
        for i in range(3):
            current_state = current_state.assign_secret_objective("player1", secret_objectives[i])
        ...
        with pytest.raises(ValueError, match="Player.*already has maximum.*3.*secret objectives"):
    ...
    def test_scoring_secret_objective_removes_it_from_hand(self):
        ...
        secret_obj = Objective("sec1", "Secret 1", "Player's secret", 1, False, GamePhase.STATUS)
...
class TestImperialStrategyCardSecretObjectives:
    ...
    def test_imperial_primary_ability_draws_secret_objective(self):
        ...
        secret_obj = Objective("sec1", "Secret 1", "New secret", 1, False, GamePhase.STATUS)
        state_with_deck = game_state.add_secret_objective_to_deck(secret_obj)
        
        # Execute Imperial primary ability
        state_after_imperial = state_with_deck.execute_imperial_primary_ability("player1")
    ...
    def test_imperial_primary_ability_respects_three_objective_limit(self):
        ...
        secret_objectives = [
            Objective(f"sec{i}", f"Secret {i}", f"Secret {i}", 1, False, GamePhase.STATUS)
            for i in range(1, 4)
        ]
        ...
        new_secret = Objective("sec4", "Secret 4", "New secret", 1, False, GamePhase.STATUS)
        ...
        with pytest.raises(ValueError, match="Cannot draw secret objective.*already at maximum"):
    ...
    def test_imperial_secondary_ability_allows_secret_objective_draw(self):
        ...
        state_after_secondary = state_with_deck.execute_imperial_secondary_ability("player1")
    ...
    def test_imperial_secondary_ability_requires_influence(self):
        ...
        with pytest.raises(ValueError, match="Insufficient influence.*requires 1 influence"):
...
class TestSecretObjectiveGameIntegration:
    ...
    def test_secret_objectives_persist_across_phases(self):
        ...
        secret_obj = Objective("sec1", "Secret 1", "Persistent secret", 1, False, GamePhase.STATUS)
    ...
    def test_completed_secret_objectives_count_toward_victory(self):
        ...
        secret_obj = Objective("sec1", "Secret 1", "High value secret", 3, False, GamePhase.STATUS)
    ...
    def test_secret_objectives_revealed_when_scored(self):
        ...
        secret_obj = Objective("sec1", "Secret 1", "Revealed secret", 1, False, GamePhase.STATUS)
...
class TestSecretObjectiveEdgeCases:
    ...
    def test_cannot_assign_duplicate_secret_objectives(self):
        ...
        secret_obj = Objective("sec1", "Secret 1", "Unique secret", 1, False, GamePhase.STATUS)
    ...
    def test_secret_objectives_removed_on_player_elimination(self):
        ...
        secret_obj = Objective("sec1", "Secret 1", "Lost secret", 1, False, GamePhase.STATUS)
    ...
    def test_multiple_players_can_have_same_secret_objective_type(self):
        ...
        secret_obj1 = Objective("sec1a", "Control Planets", "Control 6 planets", 1, False, GamePhase.STATUS)
        secret_obj2 = Objective("sec1b", "Control Planets", "Control 6 planets", 1, False, GamePhase.STATUS)
